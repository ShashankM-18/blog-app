...
const Card = () => {
  return (
    <div className="lg:mt-20 lg:mx-12 mx-4 mt-52 h-full bg-gradient-to-r from-[#96E9FB] to-[#ABECD6] rounded-2xl flex lg:flex-row items-center flex-col justify-between">
